                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            use of all our capabilities in order to save time and money of the client
                                ...
                                do not compromise with my ethics for profit.</p>
                        </div>  
                    </div>
            </section>
            <section className="container">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4">
                            ...
                            <p>I value the ability to reach an agreement on the basis of consensus, agreeing on a common meaning of
                                ...
                                creating freedom for inspiration and supporting the diversity and unique distinctiveness of my internal partners. </p>
                        </div>
                    </div>    
            </section>
            </>
